                        ...
                        <div class="card">
                            ...
                            <div class="card-body" style="margin-top: -2%">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="tags" class="form-control @error('tags') is-invalid @enderror" name="tags" placeholder="ex: fashion, men's fashion, t-shirt, etc" required/>
                                        @error('tags')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
...
{{--                                    <div class="col-md-5">--}}
{{--                                        <input type="checkbox" id="switch1" value="1" class="form-control" name="cod_status" data-switch="bool"/>--}}
...
{{--                                    <label class="col-md-7 col-form-label">Status</label>--}}
{{--                                    <div class="col-md-5">--}}
{{--                                        <input type="checkbox" id="switch3" value="1" class="form-control" name="you_may_also" data-switch="bool"/>--}}
            ...
            function generateVariantInputs() {
                ...
                if (selectedColors.length > 0) {
                    selectedColors.forEach(colorId => {
                        ...
                        if (selectedSizes.length > 0) {
                            ...
                            <div class="row mb-3 variant-row" data-color="${colorId}" data-size="${sizeId}">
                                ...
                                <div class="col-md-2">
                                    <input type="number" name="variant_discount_${colorId}_${sizeId}" class="form-control" placeholder="Discount" required />
                                </div>
                                <div class="col-md-2">
                                    <select name="variant_discount_type_${colorId}_${sizeId}" id="" class="form-control">
                                        <option value="1">Flat</option>
                        ...
                        <div class="row mb-3 variant-row" data-color="${colorId}">
                            ...
                            <div class="col-md-2">
                                    <input type="number" name="variant_discount_${colorId}" class="form-control" placeholder="Discount" required />
                                </div>
                                <div class="col-md-2">
                                    <select name="variant_discount_type_${colorId}" id="" class="form-control">
                                        <option value="1">Flat</option>
                                        <option value="1">Percent</option>
                                    </select>
                                </div>
                    ...
                    <div class="row mb-3 variant-row" data-size="${sizeId}">
                        ...
                        <div class="col-md-2">
                                    <input type="number" name="variant_discount_${sizeId}" class="form-control" placeholder="Discount" required />
                                </div>
                                <div class="col-md-2">
                                    <select name="variant_discount_type_${sizeId}" id="" class="form-control">
                                        <option value="1">Flat</option>
                                        <option value="1">Percent</option>
                                    </select>
                                </div>
