                            ...
                            <table class="table table-cart table-mobile">
                                ...
                                @foreach($cartProducts as $cartProduct)
                                    ...
                                    <tr>
                                        ...
                                        <td class="quantity-col">
                                            <div class="cart-product-quantity">
                                                <input type="number" class="form-control quantity-input" oninput="this.value = this.value.replace('/[^0-9]/', {{$cartProduct->minimum_purchase_qty}});" value="{{$cartProduct->quantity}}" max="{{$defult_stock}}" min="1" step="1" data-product-id="{{$cartProduct->id}}" data-row-total="#row-total-{{$cartProduct->id}}" required>
